        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">အမိုက်စားဖက်ရှင်တွေကို အလွယ်တကူဝယ်ယူပါ။</h1>
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent product_actions">
                                <div class="text-center row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <button class="btn btn-outline-dark flex-shrink-0 addToCart" type="button" data-id="{{$item->id}}" data-name="{{$item->name}}" data-image="{{$item->image}}" data-price="{{$item->price}}" data-discount="{{$item->discount}}">
